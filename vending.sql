...
CREATE TABLE `users_detail` (
  ...
  `congenital_disease` varchar(50) DEFAULT NULL,
  `drug_allergy` varchar(50) DEFAULT NULL,
  `phone_no` varchar(50) NOT NULL,
  `provinces` varchar(50) NOT NULL,
  `districts` varchar(50) NOT NULL,
  `sub_districts` varchar(50) NOT NULL,
...
--
ALTER TABLE `users_detail`
  ADD CONSTRAINT `users_detail_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`);
COMMIT;
